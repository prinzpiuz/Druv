...
#Build media directory structure
    ...
    sudo mkdir -p /configs/{qbit,qbit_manage,readarr,radarr,sonarr,prowlarr,jackett,bazarr,recyclarr,jellyseerr,jellyfin,emby,sabnzbd,homepage,scrutiny,myspeed,qbitrr/qBitManager,gluetun,tailscale/var/lib,tailscale/state}
